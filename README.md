...
先看 [5 张原连接位置的新旧对照](docs/previews/glyph-gap-pairs-20260911/index.html)：
“猛”“觅”通过新规则，另 3 个原位置不满足检查而跳过，不换位置补齐。
再看 [20 张新字的间隙堵塞专项预览](docs/previews/glyph-gaps-20260911/index.html)。
请反馈这 20 张的明显异常 / 合法可接受 / 不确定数量，后两项尽量附候选编号。

新预览仍为 `REVIEW`、`training_eligible=false`，不自动导入标签、不重训。
几何变化更明显不等于汉字一定非法；本轮仍需人工复核，也不是复杂广告背景或现网误报率评估。
